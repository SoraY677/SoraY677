...
const ContentLayout = ({ title, children }: Props) => {
  return (
    <div className="absolute top-0 z-100 h-full w-full max-w-full max-h-full overflow-y-scroll px-2 pb-[150px] md:pb-[250px]">
      <section className="md:w-[80%] w-[95%] min-h-[90%] max-w-[640px] overflow-hidden mx-auto  bg-opacity-80 rounded-md m-3 break-words">
        <div className="flex justify-end p-1">
          <Link href="/" className="text-md md:text-lg mix-blend-difference">
            X CLOSE
          </Link>
        </div>
